    ...
    configOffers.forEach(function (config) {
        ...
        if (finalCartValue >= Number(cartValue)) {
            ...
            getProducts.forEach(function (productDetails) {
                ...
                alert(JSON.stringify({ freebieQuantity: freebieQuantity_1, offerAppliedCustomAttributes: offerAppliedCustomAttributes }));
                alert(Number((offerAppliedCustomAttributes === null || offerAppliedCustomAttributes === void 0 ? void 0 : offerAppliedCustomAttributes._freeQuantity) || 0));

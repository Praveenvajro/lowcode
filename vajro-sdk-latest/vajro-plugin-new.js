    ...
    configOffers.forEach(function (config) {
        ...
        if (finalCartValue >= cartValue) {
            ...
            getProducts.forEach(function (productDetails) {
                ...
                var _c = lineItemsObj[variantId] || {}, lineItemHandle = _c.lineItemHandle, _d = _c.quantity, quantity = _d === void 0 ? 0 : _d, _e = _c.customAttributes._vajro_flow, _vajro_flow = _e === void 0 ? {} : _e;
